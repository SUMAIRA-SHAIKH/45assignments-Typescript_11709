...
*/
console.log('\n\t---------OBJECT{ car }---------');
function car_info(manufacturer, model, ...additionalInfo) {
    let car = Object.assign({ manufacturer, model }, Object.fromEntries(additionalInfo));
    return car;
}
;
let my_car_info = car_info("toyota", "corolla", ['color', 'black'], ['year', [2022]]);
