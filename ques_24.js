...
console.log("99.99 not equal to 100?--------------------------", (99.99 !== 100));
console.log("(125 as number)!==124)---------------------------", 125 !== 124);
console.log("(5 as number) === 6------------------------------", 5 === 6);
// Tests using "and" and "or" operators
...
console.log("\n\t~Test whether an item is in a Array~\n");
let assignmentArr = ["ques_1", "ques_2", "ques_3"]; //declear array
let assignmentStr = "ques1,ques2,ques3"; // declear variable
